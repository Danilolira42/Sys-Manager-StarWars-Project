Aqui ficará a documentação geral do projeto:

A pasta MySqldb contém o script de CREATE TABLE para o MySql e terá também um dump.sql para que você rode em sua máquina o script de banco mais atualizado contendo os dados utilizados em testes.
